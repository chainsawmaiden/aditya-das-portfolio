...
export default function NavBar({home}: {home?: boolean}) {
  return (
  <header className={`w-full sticky top-0 z-50  ${home ? 'pb-0' : 'pb-4'} left-0 text-black opacity-50 py-1 font-ppneuebit font-bold text-sm uppercase flex justify-between`}>
