...
export default function NavBar({home, article}: {home?: boolean, article?: boolean}) {
  return (
  <header className={`w-full  top-0 z-50 ${article ? 'px-3 fixed' : 'sticky'} ${home ? 'pb-0' : 'pb-6'} left-0 text-black opacity-50 py-1 font-ppneuebit font-bold text-sm uppercase flex justify-between`}>
