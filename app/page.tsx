...
export default function Home() {
  return (
    <main className="w-full px-3 font-ppneuemontreal text-smnm gap-0 flex flex-col">
        <NavBar home />
        <h1 className="md:text-xlnm text-mdnm text-left w-5/6 mx-auto lg:py-24 py-[4.5rem]">
